...
import { Loader2, LayoutDashboard, Package, Users, Settings, LogOut, ChevronLeft, Menu, FolderOpen, FileText } from "lucide-react";
...
const AdminLayout = () => {
  ...
  const navItems = [
    ...
    { name: "Categories", path: "/admin/categories", icon: FolderOpen, show: isProductManager },
