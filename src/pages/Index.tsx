...
const Index = () => {
  ...
  const badgeText = heroData?.content?.badge_text || "Authentic Rural Heritage";
  const heroBg = heroData?.images?.hero_image || heroImage;
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[90vh] flex items-center bg-pattern-subtle">
        <div className="absolute inset-0 z-0">
          <img src={heroBg} alt="Indian artisan crafts" className="w-full h-full object-cover" />
        ...
        <div className="container relative z-10 mx-auto px-4 py-20">
          <div className="max-w-2xl">
            ...
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4 animate-fade-up" style={{ animationDelay: "0.1s" }}>
              {heroTitle.includes("Desi Virasat") ? (
                <>
                  {heroTitle.split("Desi Virasat")[0]}
                  <span className="text-gradient block">Desi Virasat</span>
                  {heroTitle.split("Desi Virasat")[1]}
                </>
              ) : heroTitle}
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-up" style={{ animationDelay: "0.3s" }}>
              <Link to="/shop">
                <Button variant="hero" size="xl">Explore Collection<ArrowRight className="h-5 w-5" /></Button>
              </Link>
              <Link to="/about">
                <Button variant="heroOutline" size="xl">Our Story</Button>
              </Link>
            </div>
      ...
      <section className="py-16 md:py-24 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">Why Desi Virasat?</h2>
            <p className="text-primary-foreground/80 max-w-2xl mx-auto">
              We're not just a marketplace. We're a bridge connecting India's rich rural heritage with conscious consumers worldwide.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: Heart, title: "100% Authentic", description: "Every product is handcrafted by verified artisans using traditional techniques passed down through generations." },
              { icon: Users, title: "Direct Impact", description: "80% of your payment goes directly to the artisan. No middlemen, fair prices, real support." },
              { icon: Leaf, title: "Eco-Friendly", description: "Natural materials, traditional methods, minimal packaging. Good for you, good for the planet." },
            ].map((feature) => (
              <div key={feature.title} className="text-center p-8 rounded-2xl bg-primary-foreground/5 backdrop-blur-sm hover:bg-primary-foreground/10 transition-colors">
      ...
      <section className="py-16 md:py-24 bg-pattern-subtle">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">Are You an Artisan?</h2>
            <p className="text-muted-foreground mb-8 leading-relaxed">
              Join our community of rural artisans and reach customers across India. Share your craft, tell your story, and earn fair income from your skills.
            </p>
            <Link to="/help#sell">
              <Button variant="mustard" size="xl">Sell Your Products<ArrowRight className="h-5 w-5" /></Button>
            </Link>
          </div>
        </div>
      </section>
